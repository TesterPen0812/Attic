...
enum AgentSetupPrompt {
    static let authorizationSummary = "Stored securely in your Mac's Keychain. The token is never shown in Settings."
...
struct SettingsView: View {
    ...
    private var detail: some View {
        ...
        case .sync:
            SyncSettingsView(settings: settings, store: store)
        case .agentAccess:
